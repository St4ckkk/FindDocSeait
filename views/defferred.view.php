...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Deferred Document</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active">Defer Document</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="main-section">
            <div class="documents-table">
                ...
                <table id="deferredDocuments" class="table datatable datatable-table">
