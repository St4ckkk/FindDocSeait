...
<head>
    ...
    <title>Pending Request Document</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Pending Request Document</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <div class="main-section">
            <div class="documents-table">
                ...
                <table id="pendingRequestDocuments" class="table datatable datatable-table">
