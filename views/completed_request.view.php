...
<head>
    ...
    <title>Completed Request Document</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Completed Request Document</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <div class="main-section">
            <div class="documents-table">
                ...
                <table id="completedRequestDocuments" class="table datatable datatable-table">
